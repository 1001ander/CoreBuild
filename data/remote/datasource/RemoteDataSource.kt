...
class RemoteDataSource @Inject constructor(
    ...
    suspend fun updateCpu(id: Int, dto: CpuDto): Result<Unit> = api.updateCpu(id, dto).toUnitResult()
    ...
    suspend fun updateGpu(id: Int, dto: GpuDto): Result<Unit> = api.updateGpu(id, dto).toUnitResult()
    ...
    suspend fun updateMotherboard(id: Int, dto: MotherboardDto): Result<Unit> = api.updateMotherboard(id, dto).toUnitResult()
    ...
    suspend fun updateRam(id: Int, dto: RamDto): Result<Unit> = api.updateRam(id, dto).toUnitResult()
    ...
    suspend fun updatePsu(id: Int, dto: PsuDto): Result<Unit> = api.updatePsu(id, dto).toUnitResult()
