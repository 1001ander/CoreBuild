...
private const val INTEL_10TH_GEN = "10a Gen"
private const val FULLY_MODULAR = "Totalmente modular"
...
class ComponentLocalDataSource @Inject constructor() {
    fun getAllComponents(): List<Component> {
        return listOf(
            // CPUS INTEL (1-24)
            Component.CPU(1, "Intel Core i3-10100F", "Procesador de entrada ideal para builds de bajo presupuesto.", 70.0, "Intel", "LGA1200", INTEL_10TH_GEN, 4, 8, "3.6 GHz", "4.3 GHz", "65W"),
            Component.CPU(2, "Intel Core i5-10400F", "CPU de gama media-baja. Ideal para builds gaming de presupuesto ajustado.", 90.0, "Intel", "LGA1200", INTEL_10TH_GEN, 6, 12, "2.9 GHz", "4.3 GHz", "65W"),
            Component.CPU(3, "Intel Core i7-10700K", "Procesador desbloqueado de alto rendimiento con 8 núcleos.", 180.0, "Intel", "LGA1200", INTEL_10TH_GEN, 8, 16, "3.8 GHz", "5.1 GHz", "125W"),
            Component.CPU(4, "Intel Core i9-10900K", "Flagship de 10a generación. Orientado a gaming extremo.", 220.0, "Intel", "LGA1200", INTEL_10TH_GEN, 10, 20, "3.7 GHz", "5.3 GHz", "125W"),
            ...
            // PSU (106-115)
            Component.PSU(110, "Seasonic Focus GX-750", "Calidad excepcional con ventilador FDB silencioso.", 140.0, "Seasonic", 750, "80 Plus Gold", FULLY_MODULAR),
            Component.PSU(114, "be quiet! Dark Power 13", "Silenciosa por excelencia con eficiencia Titanium.", 320.0, "be quiet!", 1000, "80 Plus Titanium", FULLY_MODULAR),
            Component.PSU(115, "Corsair HX1200i", "1200W con monitoreo digital para sistemas extremos.", 350.0, "Corsair", 1200, "80 Plus Platinum", FULLY_MODULAR)
        )
    }
}
